            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-white text-sm font-medium mb-2">
                  Month {selectedMonth && !selectedYear && <span className="text-red-400 text-xs">(Year required)</span>}
                </label>
                <select
                  value={selectedMonth}
                  onChange={(e) => setSelectedMonth(e.target.value)}
                  className={`w-full bg-white/90 border rounded-lg px-3 py-2 text-gray-800 focus:ring-2 focus:ring-purple-400 focus:border-transparent ${
                    selectedMonth && !selectedYear ? 'border-red-400' : 'border-white/30'
                  }`}
                >
                ...
                {selectedMonth && !selectedYear && (
                  <p className="text-red-400 text-xs mt-1">Please select a year to filter by month</p>
                )}
              </div>
